...
def test_merge_summary_includes_retrieval_slices_by_bucket() -> None:
    ...
    eval_items = [
        {"item_meta": {"slice_file_type": "pdf", "slice_language": "zh", "slice_directory": "a", "retrieval_recall": 1.0, "retrieval_hit_at_20": True, "abstain_triggered": False}},
        {"item_meta": {"slice_file_type": "pdf", "slice_language": "zh", "slice_directory": "a", "retrieval_recall": 0.0, "retrieval_hit_at_20": False, "abstain_triggered": True}},
        {"item_meta": {"slice_file_type": "md", "slice_language": "en", "slice_directory": "b", "retrieval_recall": 1.0, "retrieval_hit_at_20": True, "abstain_triggered": False}},
    ]
