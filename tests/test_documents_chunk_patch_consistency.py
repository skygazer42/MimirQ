...
def test_patch_chunk_strict_mode_emits_drift_marker_and_returns_409(monkeypatch):  # noqa: ANN001
    ...
    monkeypatch.setattr(documents_module.settings, "INDEX_CONSISTENCY_PATCH_CHUNK_STRICT", True, raising=False)
    ...
    assert markers[-1]["schema"] == "mimirq.index_drift_marker.v1"
    assert markers[-1]["operation"] == "chunk.patch"
