...
def test_load_app_specs_reads_key_file_without_emitting_secrets(tmp_path: Path) -> None:
        ...
        json.dumps(
            {
                ...
                "a3c86554-fe1d-41d5-ad3e-bf5fabff38a7": {"api_key": "http-secret", "mode": "workflow"},
            }
        ),
        encoding="utf-8",
    )
    ...
    assert by_label["dify_native_kb"].app_id == "a398a1b8-0f88-4528-9221-329ca022e3cc"
...
def test_key_requirements_describes_missing_dify_app_keys_without_secrets() -> None:
    ...
    assert "a3c86554-fe1d-41d5-ad3e-bf5fabff38a7" in requirements["apps"][0]["accepted_keys"]
...
def test_resolve_app_modes_selects_workflow_when_chat_probe_fails() -> None:
    ...
    resolved, report = mod.resolve_app_modes(
        ...
        base_url="https://ai.kingdonsoft.com:5001/v1",
        timeout=1,
        workflow_query_key="query",
        user_prefix="test",
        force=False,
