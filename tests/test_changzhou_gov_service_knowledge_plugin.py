...
def test_changzhou_plugin_adds_semantic_keys_for_equivalent_qa_and_service_records():
    common_source = "/path/to/gov-service-knowledge/03常州市常见问题/常见问题优化补充.txt"
    common_text = """问题：[办理生育登记]
==##相似问法：准生证、生育联系单##==
答案：可通过苏服办办理生育登记。
"""
    district_source = "/path/to/gov-service-knowledge/06各区常见问题/天宁区12345QA.txt"
    district_text = """问题：[已经怀孕，生育服务联系单（准生证）要如何办理？]
答案：可通过我的常州 APP 或街道窗口办理。
来源部门：常州市天宁区卫生健康局
"""
    service_source = "/path/to/gov-service-knowledge/01政务服务事项知识/武进区事项清单.txt"
...
def test_changzhou_plugin_governs_common_qa_quoted_answer_labels():
    source = "/path/to/gov-service-knowledge/03常州市常见问题/2026年实施大规模设备更新和消费品以旧换新政策.txt"
