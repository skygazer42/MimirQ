...
async def test_agentic_runner_emits_self_rag_metrics_after_answer(
    ...
    AgenticPlanStep = rag_agent_mod.AgenticPlanStep
    AgenticRAGRunner = rag_agent_mod.AgenticRAGRunner
    ...
    async def _fake_plan(*_args, **_kwargs):  # noqa: ANN003
        return [AgenticPlanStep(query="focused retrieval query", rationale="Need one grounded answer.")]
