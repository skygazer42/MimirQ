...
async def test_kg_recall_filters_entities_by_document_scope(monkeypatch: pytest.MonkeyPatch):
    ...
    class _FakeEventRepository:
        ...
        def search_events_by_entities(self, entity_ids, tenant_id, limit=50, document_ids=None):  # noqa: ANN001
            return []

        def search_similar_by_content(self, query_vector, tenant_id, k=20, document_ids=None):  # noqa: ANN001
            return []

        def get_events_by_ids(self, ids, *, tenant_id=None, document_ids=None):  # noqa: ANN001
            return []

        def get_event_entities(self, event_ids, *, tenant_id=None):  # noqa: ANN001
            return {}
