...
| `documents.ts` | `/api/v1/documents/`, `/api/v1/documents/batch-delete`, `/api/v1/documents/batch-upload/apply-urls`, `/api/v1/documents/batch-upload/status/{batch_id}`, `/api/v1/documents/batch/access`, `/api/v1/documents/batch/archive`, `/api/v1/documents/batch/disable`, `/api/v1/documents/batch/enable`, `/api/v1/documents/batch/metadata`, `/api/v1/documents/batch/move`, `/api/v1/documents/batch/reingest`, `/api/v1/documents/batch/retry` … |
...
| `health.ts` | `/api/v1/health`, `/api/v1/health/ready` |
| `meta.ts` | `/api/v1/meta` |
| `parsing.source.test.ts` | `/api/v1/parsing/documents/{document_id}/extract` |
