...
| `meta.ts` | `/api/v1/meta` |
| `parsing.ts` | `/api/v1/parsing/documents/{document_id}/content`, `/api/v1/parsing/documents/{document_id}/parse` |
| `pipeline.ts` | `/api/v1/pipeline/capabilities`, `/api/v1/pipeline/chunk-preview`, `/api/v1/pipeline/clean-preview`, `/api/v1/pipeline/clean-rules`, `/api/v1/pipeline/extract-keywords`, `/api/v1/pipeline/governance-analyze`, `/api/v1/pipeline/governance-profiles`, `/api/v1/pipeline/governance-profiles/import`, `/api/v1/pipeline/governance-profiles/{profile_ref}`, `/api/v1/pipeline/governance-profiles/{profile_ref}/resolved`, `/api/v1/pipeline/learn-common-lines`, `/api/v1/pipeline/llm-clean-preview` |
