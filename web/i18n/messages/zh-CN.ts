const zhCNMessages = {
  ...
  AuditPage: {
    ...
    presets: {
      ...
      evidenceDriftDaily: '证据漂移（日常）',
      accessGraphExport: '访问图谱（导出）',
    },
    actions: {
      refresh: '刷新',
      reset: '重置',
  ...
  AccessReviewPage: {
    ...
    summary: {
      heading: '汇总',
      description:
        '用于日常访问审查与排查“为什么某个用户被拒绝”（目录/组/白名单维度），不包含文档内容。',
    ...
    export: {
      ...
      includeSensitiveDescription:
        '开启后可能包含组名 / external_id / 用户 ID 等字段，仅建议用于审计导出与合规流程。',
    },
    warnings: {
    ...
    toasts: {
      downloadJson: '已下载访问图谱（JSON）',
      downloadPages: '已下载访问图谱（{pages}页）',
    },
    errors: {
      loadSummary: '加载访问审查汇总失败',
      loadSummaryFallback:
        '无法加载访问审查汇总。请确认你是管理员，并且后端已更新到包含 `/api/v1/audit/access-graph/summary` 的版本。',
      export: '导出访问图谱失败',
    },
  },
  ...
  ChunkPreview: {
    ...
    chunkList: {
      ...
      batch: {
        trigger: 'Batch',
        skipFiltered: 'SKIP filtered ({count})',
        skipFilteredSuccess: 'SKIP filtered: {count}',
        skipDuplicates: 'SKIP DUP ({count})',
        skipDuplicatesSuccess: 'SKIP DUP: {count}',
        skipShort: 'SKIP SHORT ({count})',
        skipShortSuccess: 'SKIP SHORT: {count}',
        skipParents: 'SKIP parents ({count})',
        skipParentsSuccess: 'SKIP parents: {count}',
        skipChildren: 'SKIP children ({count})',
        skipChildrenSuccess: 'SKIP children: {count}',
        restoreAll: 'RESTORE all ({count})',
        restoreAllSuccess: 'RESTORE all: {count}',
        restoreFiltered: 'RESTORE filtered',
        restoreFilteredSuccess: 'RESTORE filtered: {count}',
      },
      filters: {
        onlyShortTitle: 'Only SHORT',
        shortLabel: 'SHORT {count}',
        onlyDuplicateTitle: 'Only DUP',
        duplicateLabel: 'DUP {count}',
        onlyGapTitle: 'Only GAP',
        onlyGapTitleChildCoverage: 'Only GAP (child coverage)',
        gapLabel: 'GAP {count}',
        onlyOverlapTitle: 'Only OVR',
        onlyOverlapTitleChildCoverage: 'Only OVR (child coverage)',
        overlapLabel: 'OVR {count}',
        onlyNeedsReviewTitle: 'Only needs_review (semantic heuristics)',
        reviewLabel: 'REVIEW {count}',
        onlyEditedTitle: 'Only EDIT',
        editedLabel: 'EDIT {count}',
        onlySkippedTitle: 'Only SKIP',
        skippedLabel: 'SKIP {count}',
      },
      actions: {
        clearSelection: '清除锁定',
      ...
      selectedChunk: {
        ...
        lengthWithTokens: '{tokens} tok · {chars} chars',
        lengthCharsOnly: '{chars} chars',
        lengthCharsWithTokens: '{chars} chars · {tokens} tok',
        pageLabel: ' · P.{page}',
        tokenLabel: ' · {count} tok',
        citationLine: '【{name} · chunk #{index}{pageLabel}{tokenLabel} · {start}-{end}】',
        copyCitation: '复制引用',
        copyCitationSuccess: '已复制引用',
        copyMarkdown: '复制为 Markdown 代码块',
        copyMarkdownSuccess: '已复制 Markdown 代码块',
        unlock: '取消锁定',
      },
  ...
  KGDiagnosticsPage: {
    page: {
      title: 'KG 检索评测',
      description: '运行一轮 KG 检索评测，查看核心指标、抽取质量，并对比不同历史 run 的变化。',
      actions: {
        refreshRuns: '刷新运行记录',
        run: '开始评测',
        exportRun: '导出本次结果',
    ...
    runConfig: {
      title: '评测设置',
      datasetId: '数据集 ID',
      datasetPlaceholder: '输入 dataset UUID',
      hardcaseMode: '难例生成模式',
      ...
      autoExtractKg: '评测前补抽 KG',
      persistRun: '保存运行结果',
    },
    qualityReport: {
      title: '抽取质量',
      hint: '拉取当前数据集的聚合质量报告，先判断 KG 抽取层是否稳定。',
      pull: '拉取质量报告',
      documentLimit: '抽样文档上限',
      pipelineHash: '指定 pipeline_hash（可选）',
      pipelineHashPlaceholder: '留空表示当前生效 pipeline',
    },
    summary: {
      title: '本次评测',
      baselineHitRate: '命中率',
    ...
    runs: {
      ...
      runA: '对比基线 A',
      runAPlaceholder: '选择 run A',
      loadA: '加载 A',
      runB: '对比目标 B',
      runBPlaceholder: '选择 run B',
      loadB: '加载 B',
    },
    compare: {
      title: 'Run 对比',
      export: '导出对比结果',
      exported: '已导出 diff.json',
      hitFlips: '命中翻转',
      summaryKeys: '指标变化项',
      empty: '选择并加载两个历史 run 后，这里会自动生成对比结果。',
      diffJson: '原始 diff JSON',
      diffHint: '加载 run A / B 后生成对比结果。',
    ...
    workspace: {
      ...
      extractionHint: '控制评测前是否补抽 KG，以及是否把本轮结果保留下来供后续比较。',
      autoExtractHint: '如果当前文档还没抽取完 KG，可在评测前自动补一次。',
      autoExtractBadge: 'Auto KG',
      persistRunBadge: 'Run Diff',
      enabled: '已启用',
      disabled: '已关闭',
      runIntro: '优先查看刚完成的一次评测结果，确认命中率、Recall 与未命中样本。',
      qualityIntro: '面向抽取层，拉取当前数据集的聚合质量报告，排查 KG 是否抽得稳。',
      compareIntro: '选择两个已保存的历史 run，对比命中翻转与指标变化。',
      runStateTitle: '运行状态',
      runPersisted: '本轮结果已保存，可直接拿去和历史 run 对比。',
      runTransient: '本轮结果只保存在当前页面，不会出现在历史列表。',
      itemsLabel: '评测样本',
      itemsHint: '后端这轮返回的 case 明细数量',
      failuresLabel: '未命中样本',
    ...
    toasts: {
      ...
      diagnosticsRan: '已完成 KG 检索评测',
      diagnosticsRunFailed: '运行 KG 检索评测失败',
