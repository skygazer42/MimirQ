...
History: {
    ...
    noConversationRecords: '还没有历史记录',
    startConversationHint: '去首页发起新对话开始探索',
    historyEmptyKicker: '对话档案',
    historyEmptyDescription: '完成一次对话后，这里会按时间整理记录。',
    ...
    noConversationSelected: '选择一段对话继续回看',
    noConversationSelectedDescription:
      '从左侧选择一段记录，即可查看完整回答、引用证据和评测轨迹。',
    startFirstConversation: '从一次具体提问开始',
    startFirstConversationDescription:
      '回答、引用证据与评测结果会随对话一起保存，之后可随时回看。',
