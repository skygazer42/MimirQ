...
export const REPORT_PANEL_CLASS =
  'rounded-[1.15rem] border border-border/60 bg-card p-3.5 shadow-none'
...
export const REPORT_PRIMARY_ACTION_CLASS =
  'h-9 gap-1.5 rounded-xl bg-info px-3.5 text-xs font-semibold text-info-foreground shadow-none hover:bg-info/90'
...
export const REPORT_METRIC_LEDGER_CLASS =
  'grid overflow-hidden rounded-[1.2rem] border border-border/60 bg-border/60 shadow-none md:grid-cols-3 2xl:grid-cols-6'
