...
const DropdownMenuSubTrigger = React.forwardRef<
  RadixRef<typeof DropdownMenuPrimitive.SubTrigger>,
  Readonly<React.ComponentPropsWithoutRef<typeof DropdownMenuPrimitive.SubTrigger> & {
    inset?: boolean
  }>
...
const DropdownMenuContent = React.forwardRef<
  RadixRef<typeof DropdownMenuPrimitive.Content>,
...
const DropdownMenuItem = React.forwardRef<
  RadixRef<typeof DropdownMenuPrimitive.Item>,
...
const DropdownMenuCheckboxItem = React.forwardRef<
  RadixRef<typeof DropdownMenuPrimitive.CheckboxItem>,
...
const DropdownMenuRadioItem = React.forwardRef<
  RadixRef<typeof DropdownMenuPrimitive.RadioItem>,
...
const DropdownMenuLabel = React.forwardRef<
  RadixRef<typeof DropdownMenuPrimitive.Label>,
  Readonly<React.ComponentPropsWithoutRef<typeof DropdownMenuPrimitive.Label> & {
    inset?: boolean
  }>
>(({ className, inset, ...props }, ref) => (
...
const DropdownMenuSeparator = React.forwardRef<
  RadixRef<typeof DropdownMenuPrimitive.Separator>,
