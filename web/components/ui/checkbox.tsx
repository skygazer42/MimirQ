...
const Checkbox = React.forwardRef<
  RadixRef<typeof CheckboxPrimitive.Root>,
...
>(({ className, ...props }, ref) => (
  ...
  >
    <CheckboxPrimitive.Indicator
      className={cn("flex items-center justify-center text-current data-[state=checked]:animate-in data-[state=checked]:zoom-in-75")}
    >
