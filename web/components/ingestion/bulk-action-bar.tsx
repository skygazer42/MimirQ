...
function ActionTile({
  ...
  return (
    ...
    >
      <span className="inline-flex h-6 w-6 items-center justify-center rounded-full bg-card/88 ring-1 ring-info/30 shadow-[inset_0_1px_0_rgba(255,255,255,0.75)] dark:bg-card/10 dark:ring-white/10">
