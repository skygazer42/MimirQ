...
describe('ParsingPage workbench scaffold', () => {
  it('moves the scaffold rendering into the extracted shell component', () => {
    ...
    expectSourceToContain(shellSrc, 'KnowledgeOpsHero')
    expectSourceToContain(shellSrc, 'KnowledgeOpsFlowCard')
    expectSourceToContain(shellSrc, "title={t('title')}")
    expectSourceToContain(shellSrc, "description={t('description')}")
