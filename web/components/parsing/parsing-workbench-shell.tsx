...
function ParsingWorkbenchMark(props: Readonly<SVGProps<SVGSVGElement>>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" aria-hidden="true" {...props}>
      ...
      />
      <path
        d="M14.75 3.75V7a1 1 0 0 0 1 1H19"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinecap="round"
      ...
      />
      <path
        d="M8.5 10.25h5.75M8.5 13h7M8.5 15.75h4.25"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinecap="round"
      />
            ...
            <div className="flex min-w-0 items-start gap-3">
              ...
              <div className="min-w-0 pt-0.5">
                <div className="flex min-w-0 items-center gap-2">
                  <h1 className="truncate text-[17px] font-semibold leading-6 text-foreground md:text-[19px]">
                    {t('title')}
                  </h1>
                </div>
              ...
              {activeFile || activeLibraryFile ? (
                ...
                <div className="flex flex-1 items-center justify-center">
                  <div className="max-w-md text-center">
                    ...
                    <h3 className="mb-2 text-lg font-medium text-foreground/80 dark:text-muted-foreground">
                      {t('emptyTitle')}
                    </h3>
