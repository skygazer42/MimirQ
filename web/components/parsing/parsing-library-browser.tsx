...
export function ParsingLibraryBrowser({
 ...
 type="button"
 className={cn(
 'group relative flex w-full cursor-pointer items-center gap-2.5 rounded-lg p-2 text-left transition-colors hover:bg-muted/60 dark:hover:bg-muted/40',
 dragOverFolderId === folder.id && 'bg-muted/60 ring-1 ring-border/60 dark:bg-muted/40',
