...
describe('original preview messages source', () => {
  it('routes original preview header, tabs, and empty states through next-intl', () => {
    ...
    expect(src).toContain("t('originalPreview.titlePdf')")
    expect(src).toContain('originalPreview.charCount')
    expect(src).toContain('previewData?.total_characters')
    expect(src).toContain('stats={previewData.stats}')
    expect(src).not.toContain('effectiveOriginalText?.length ?? previewData.total_characters')
    ...
    expect(src).toContain("t('originalPreview.tabs.pdf')")
    ...
    expect(src).toContain("t('originalPreview.hints.pdfMode')")
