...
describe('chunk inspector dialog source', () => {
  it('routes chunk inspector labels and validation copy through next-intl', () => {
    ...
    expect(src).toContain("t('chunkInspector.contentHelper')")
    expect(src).toContain('chunkInspector.contentStats')
    expect(src).toContain("t('chunkInspector.sidePanelLabel')")
    expect(src).toContain("t('chunkInspector.sidePanelHelper')")
    expect(src).toContain("t('chunkInspector.metadataTab')")
    expect(src).toContain("t('chunkInspector.embeddingTab')")
    expect(src).toContain("t('chunkInspector.metadataLabel')")
    expect(src).toContain("t('chunkInspector.metadataHelper')")
