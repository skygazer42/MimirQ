	                    ...
	                    <div className="space-y-3">
	                      ...
	                      <div className="space-y-2">
	                        {(diffResult.diff || []).map((it) => (
	                          <div
	                            key={String(it.key)}
	                            className="grid grid-cols-1 gap-2 rounded-lg border border-border/50 bg-card px-3 py-2 md:grid-cols-3"
	                          >
            ...
            <Panel variant="glass" className="overflow-hidden" padding="none">
              ...
              <div className="p-4 space-y-2">
                {(selected.steps || []).map((s) => (
                  <div key={s.key} className="flex items-start justify-between gap-3 rounded-lg border border-border/50 bg-card px-3 py-2">
