...
describe('rag trace panel source', () => {
  ...
  it('moves pipeline timeline and channel section copy into next-intl lookups', () => {
    ...
    expect(src).toContain('t("panel.evidencePreview.title")')
    expect(src).toContain('t("panel.evidencePreview.description"')
    expect(src).toContain('t("panel.evidencePreview.loading")')
    expect(src).toContain('t("panel.evidencePreview.loaded")')
    expect(src).toContain('t("panel.evidencePreview.score")')
    expect(src).toContain('t("panel.evidencePreview.document")')
    expect(src).toContain('t("panel.evidencePreview.chunk")')
    expect(src).toContain('t("panel.evidencePreview.missingContent")')
    expect(src).toContain('t("panel.evidencePreview.takeaway")')
    expect(src).toContain('t("panel.evidencePreview.kinds.examRequired")')
    expect(src).toContain('t("panel.evidencePreview.reasons.examRequired")')
    expect(src).toContain('t("panel.evidencePreview.open")')
    expect(src).toContain('documentApi.getChunk(documentId, chunkId)')
