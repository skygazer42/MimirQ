...
describe('rag trace panel source', () => {
  ...
  it('moves citation channel labels and pipeline inspector summaries into next-intl lookups', () => {
    const src = fs.readFileSync(path.resolve(__dirname, 'rag-trace-panel.tsx'), 'utf8')

    expect(src).toContain('t("panel.channels.options.all.label")')
    expect(src).toContain('t("panel.channels.options.all.summary")')
    expect(src).toContain('t("panel.channels.options.vector.label")')
    expect(src).toContain('t("panel.channels.options.vector.summary")')
    expect(src).toContain('t("panel.channels.options.bm25.label")')
    expect(src).toContain('t("panel.channels.options.bm25.summary")')
    expect(src).toContain('t("panel.channels.options.lexicalDb.label")')
    expect(src).toContain('t("panel.channels.options.lexicalDb.summary")')
    expect(src).toContain('t("panel.channels.options.sparse.label")')
    expect(src).toContain('t("panel.channels.options.sparse.summary")')
    expect(src).toContain('t("panel.channels.options.colbert.label")')
    expect(src).toContain('t("panel.channels.options.colbert.summary")')
    expect(src).toContain('t("panel.inspector.retrieveSummary")')
    expect(src).toContain('t("panel.inspector.retrieveCallout"')
    expect(src).toContain('t("panel.inspector.retrieveEnabled")')
    expect(src).toContain('t("panel.inspector.retrieveDisabled")')
    expect(src).toContain('t("panel.inspector.rerankSummary")')
    expect(src).toContain('t("panel.inspector.rerankSkipped"')
