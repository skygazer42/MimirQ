...
describe('retrieval ablations visual layout', () => {
  it('matches the three-card ablation workspace reference', () => {
    ...
    expect(src).toContain('bg-info px-1.5 py-0.5 text-[9px] font-medium text-primary-foreground')
    expect(src).toContain('bg-info px-4 text-[13px] text-primary-foreground')
