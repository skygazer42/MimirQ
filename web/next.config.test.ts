...
describe('next config security headers', () => {
  ...
  it('allows localhost plus LAN development origins for Next dev resources', () => {
    const origins = resolveAllowedDevOrigins(
      {
        NEXT_ALLOWED_DEV_ORIGINS: 'demo.internal, 192.0.2.20',
        NODE_ENV: 'development',
      },
      {
        eth0: [
          { address: '192.0.2.6', family: 'IPv4', internal: false, netmask: '255.255.255.0', mac: '00:11:22:33:44:55', cidr: '192.0.2.6/24' },
    ...
    expect(origins).toContain('192.0.2.6')
    expect(origins).toContain('192.0.2.20')
