...
from app.schemas.sag import SAGExtractResponse, SAGSearchRequest, SAGSearchResponse
from app.services.dataset_service import DatasetService
from app.services.sag_pipeline import extract_events, sag_search
...
async def run_sag_search(
    ...
    """
    _ensure_enabled()
    effective_tenant: Optional[UUID] = payload.tenant_id or tenant_id

    try:
        result = await sag_search(query=payload.query, tenant_id=effective_tenant)
