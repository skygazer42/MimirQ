...
from app.rag.chunkers_legacy.chunkers.book import chunk as book_chunk
from app.rag.chunkers_legacy.chunkers.laws import chunk as laws_chunk
from app.rag.chunkers_legacy.chunkers.email import chunk as email_chunk
