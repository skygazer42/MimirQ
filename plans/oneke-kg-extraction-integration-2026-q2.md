...
> 语料: `/data/temp50/20260522政务服务智能客服知识`(常州市政务客服 27 文件)
...
本调研评估接入 **OneKE**(ZJUNLP, WWW 2025, MIT, 基于 Chinese-Alpaca-2-13B 双语 IE 大模型)作为 MimirQ KG 抽取的第二条 backend,与现有 LLM/GLiNER/Hybrid/Heuristic 4-backend 并存,**不替换**任何现有抽取器。语料用 `/data/temp50/20260522政务服务智能客服知识`(常州市政务客服 27 文件:8 区事项清单 / 12345 QA / 一件事 / 6 业务部门 QA 含公积金/不动产/医保/应急局)。
