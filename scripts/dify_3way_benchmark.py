...
DEFAULT_BASE_URL = "https://ai.kingdonsoft.com:5001/v1"
...
DEFAULT_APP_SPECS = [
    ...
    },
    {
        ...
        "app_id": "a398a1b8-0f88-4528-9221-329ca022e3cc",
        ...
        rows.append(
            {
                ...
                "workflow_url": f"https://ai.kingdonsoft.com:3000/brainai/app/{app.app_id}/workflow",
            }
        )
...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        default=os.getenv("DIFY_CONSOLE_API_BASE_URL") or "https://ai.kingdonsoft.com:5001/console/api",
    )
    parser.add_argument("--dify-console-token", default=os.getenv("DIFY_CONSOLE_TOKEN") or "")
    parser.add_argument("--dify-console-storage-state", default="/tmp/kingdonsoft_dify_storage_state.json")
