...
| 系统标签 | Dify App ID | 类型 |
| --- | --- | --- |
| `dify_native_kb` | `a398a1b8-0f88-4528-9221-329ca022e3cc` | 原生 Dify 知识库 |
| `dify_http_mimirq` | `a3c86554-fe1d-41d5-ad3e-bf5fabff38a7` | HTTP 接入 MimirQ，可回写证据 |
| `dify_external_mimirq` | `3c1c8b66-94c1-44fb-a09c-b1856d970eb7` | Dify External Knowledge 接入 MimirQ |

默认 App API 地址为 `https://ai.kingdonsoft.com:5001/v1`。页面工作流地址 `https://ai.kingdonsoft.com:3000/brainai/app/.../workflow` 不是 App API 调用地址。
...
```json
{
  "a398a1b8-0f88-4528-9221-329ca022e3cc": "app-xxx",
  "a3c86554-fe1d-41d5-ad3e-bf5fabff38a7": "app-xxx",
  "3c1c8b66-94c1-44fb-a09c-b1856d970eb7": "app-xxx"
}
```
