...
> **联调视角**：反馈与质量闭环可与「可对用户问答」验收结合；详见手册 [可对用户问答](https://skygazer42.github.io/MimirQ/handbook/docs/integration/tasks/knowledge-base-qa)（入口亦可从 [集成总览](https://skygazer42.github.io/MimirQ/handbook/docs/integration/welcome)）。
