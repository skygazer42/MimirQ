...
> **联调视角**：部署完成后建议按手册 [首日上线](https://skygazer42.github.io/MimirQ/handbook/docs/integration/tasks/go-live-tenant) 做一轮冒烟（[集成总览](https://skygazer42.github.io/MimirQ/handbook/docs/integration/welcome)）。
