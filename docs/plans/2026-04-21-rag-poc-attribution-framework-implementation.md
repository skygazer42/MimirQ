...
- [x] Step 1: Write failing tests for citation heat + negative feedback heat aggregation.
- [x] Step 2: Run `pytest -q tests/test_poc_runner_coverage_heatmap.py` and confirm red.
- [x] Step 3: Implement the heat aggregation module.
- [x] Step 4: Re-run `pytest -q tests/test_poc_runner_coverage_heatmap.py` until green.
- [x] Step 5: Commit the task.
...
- [x] Step 1: Write failing report-builder tests.
- [x] Step 2: Run `pytest -q tests/test_poc_runner_attribution_report.py` and confirm red.
- [x] Step 3: Implement the structured report builder.
- [x] Step 4: Re-run `pytest -q tests/test_poc_runner_attribution_report.py` until green.
- [x] Step 5: Commit the task.
...
- [x] Step 1: Write failing tests for HTML report generation and presence of key sections.
- [x] Step 2: Run `pytest -q tests/test_poc_runner_html_report.py` and confirm red.
- [x] Step 3: Implement the HTML report renderer.
- [x] Step 4: Re-run `pytest -q tests/test_poc_runner_html_report.py` until green.
- [x] Step 5: Commit the task.
...
- [x] Step 1: Write failing API tests for HTML report output.
- [x] Step 2: Run `pytest -q tests/test_dataset_analysis_html_api.py` and confirm red.
- [x] Step 3: Implement the HTML report endpoint.
- [x] Step 4: Re-run `pytest -q tests/test_dataset_analysis_html_api.py` until green.
- [x] Step 5: Commit the task.
...
- [x] Step 1: Write failing tests for task creation, status transitions, and result retrieval.
- [x] Step 2: Run `pytest -q tests/test_poc_runner_png_tasks.py` and confirm red.
- [x] Step 3: Implement the minimal PNG task/result logic.
- [x] Step 4: Re-run `pytest -q tests/test_poc_runner_png_tasks.py` until green.
- [x] Step 5: Commit the task.
...
- [x] Step 1: Write failing tests for full-report PNG generation flow.
- [x] Step 2: Run `pytest -q tests/test_poc_runner_png_report.py` and confirm red.
- [x] Step 3: Implement the PNG rendering path.
- [x] Step 4: Re-run `pytest -q tests/test_poc_runner_png_report.py` until green.
- [x] Step 5: Commit the task.
...
- [x] Step 1: Write failing API tests for PNG task creation/status/result.
- [x] Step 2: Run `pytest -q tests/test_dataset_analysis_png_api.py` and confirm red.
- [x] Step 3: Implement the PNG APIs.
- [x] Step 4: Re-run `pytest -q tests/test_dataset_analysis_png_api.py` until green.
- [x] Step 5: Commit the task.

### Batch B Verification Gate

- [x] Run the complete Batch B targeted suite.
...
- [x] Re-run any relevant dataset analysis/export API tests from Batch A to confirm no regressions.

- [x] Update `docs/plans/2026-04-21-backend-plan-execution-roadmap.md` after Batch B is verified.
