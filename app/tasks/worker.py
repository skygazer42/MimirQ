...
from app.tasks.jobs import process_document_job, ping_job, extract_kg_job, rebuild_indexes_job
...
class WorkerSettings:
    ...
    functions = [process_document_job, extract_kg_job, rebuild_indexes_job, ping_job]
