"""
Parse-then-Correct VLM correction scaffolding.

Opt 4 (docs/plans/2026-03-19-document-parsing-optimization.md):
- Allow an external VLM backend to correct low-quality parsed markdown.

Safety:
- Disabled by default.
- External HTTP only (no heavyweight model deps in-process).
- Bounded payload sizes and page counts.
"""
