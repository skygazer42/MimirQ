...
# Compatibility exports kept explicit because support modules and tests still
# import or monkeypatch this facade after logic moved into support packages.
__all__ = (
    "_append_ocr_quality_candidate",
    "_append_unmergeable_chunk",
    "_apply_inline_asset_audit_patch",
    ...
    "_try_merge_with_previous_chunk",
    "_uniform_sample_indices",
    "add_chart_data_blocks",
    "add_formula_latex_blocks",
    "add_image_captions",
    "add_image_code_blocks",
