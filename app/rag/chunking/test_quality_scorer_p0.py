...
class TestChunkSizeBounds:
    ...
    def test_chunk_too_small(self):
        ...
        assert MIN_CHUNK_SIZE_TOKENS in result["warning"]
...
class TestRealWorldScenarios:
    ...
    def test_table_chunk(self):
        ...
        # Tables might be small but still valid
        assert scores["size_validation"]["size_category"] == "below_optimal"
        assert scores["size_validation"]["severity"] == "warning"
