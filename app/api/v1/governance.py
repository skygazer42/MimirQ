...
def list_stale_documents_by_dataset(
    ...
    due_within_days: int = Query(default=7, ge=0, le=365, description="Used for mode=due_soon/all when due_before is not set"),
    due_before: datetime | None = Query(default=None, description="Optional explicit upper bound for review_due_at"),
    as_of: datetime | None = Query(default=None, description="Optional reference time (defaults to now, UTC)"),
    include_inactive: bool = Query(default=False, description="Include archived/disabled documents"),
